...
turma_model = turmas_ns.model("Turma", {
    ...
    "professor_id": fields.Integer(required=True, description="ID do professor associado à turma"),  # Adicionado
})
...
turma_output_model = turmas_ns.model("TurmaOutput", {
    ...
    "professor_id": fields.Integer(description="ID do professor associado à turma"),  # Adicionado
})
